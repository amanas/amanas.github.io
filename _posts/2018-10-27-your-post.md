...
library(projectLib)
project <- projectLib::Project$new(projectId="703393e9-3acf-4b02-9c56-0a3b9f0b49ca", projectToken="p-a8cd6dd63668fc581457e0f7d2364949a4ca6eee")
pc <- project$project_context

# Fetch data
my.file <- project$get_file("SoTA.csv")

# Read the CSV data file from the object storage into a data frame
data <-  read.csv(text = rawToChar(my.file), sep = ';', header = T)
```
